...
def replayMes():
    res = '非常感谢您的留言，如在上班时间我们将第一时间回复，如节假日因48小时未回复，按微信平台规则不能再回复，敬请谅解！\n' \
          ...
          '预防保健科：3821379。\n【核酸检测】\n我院提供24小时核酸采样，检验报告出具时间：上午12:00前采样的，当天下午15:30左右可以查询结果；' \
          '下午20:00前采样的，当天晚上23:30左右可以查询结果；当日20:00-次日早上8:00采样的，次日下午13:00左右可以查询结果。' \
          '如遇标本过多等情况，出报告时间可能会延迟，敬请谅解。\n如需查询并下载新冠核酸检验结果，请发送' \
          '【采样时登记的手机号码或电话号码*证件号】获取。例：13123456789*441234567894561235'
    return res
