    ...
    if request.method == 'GET':
        ...
        if msg.type == 'event':
            if msg.event == 'subscribe':
                ...
                elif msg.key == 'profile':
                    tempMsg = "湛江市赤坎区人民医院创建于1985年，是赤坎区唯一一家集医疗、教学、预防、康复为一体的二级综合医院，" \
                              "是湛江中心人民医院住院医师规范化培训全科专业基层实践基地、湛江市职工医保和城乡居民医保定点一类医院、" \
                              "湛江市公安局交警支队车辆管理所机动车驾驶人体检定点单位、赤坎区离休干部公费医疗的定点医院、" \
                              "广东省餐饮行业服务人员健康体检定点单位。\n现有职工249人，其中副高以上职称14人，中级职称35人，初级职称144人。\n" \
                              "拥有联影uCT550-80层螺旋CT、DR、GE-E6四维彩超、腹腔镜、输尿管镜等先进设备。\n" \
                              "本院设有内科、外科、妇产科（妇科、产科）、儿科、中医科、肛肠痔疮科、康复科（骨伤疼痛科）、口腔科、耳鼻喉科、健康体检中心、犬伤门诊等科室。"
                elif msg.key == 'report':
